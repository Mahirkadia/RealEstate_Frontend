      ...
      <div className='flex flex-col items-start gap-8'>
        ...
        <div className='flex-1 bg-white w-full mb-8 border border-gray-300 rounded-lg px-6 py-8'>
          ...
          <form action='' method='post' className='flex flex-col gap-y-4'>
            ...
            px-4 h-14 text-sm' type='text' placeholder='Name*'/>
            <input className='border  border-gray-300 focus:border-violet-700 outline-none rounded w-full
            px-4 h-14 text-sm' type='text' placeholder='Email*'/>
            <input className='border  border-gray-300 focus:border-violet-700 outline-none rounded w-full
            px-4 h-14 text-sm' type='text' placeholder='Phone*'/>
            <textarea className='border border-gray-300 focus:border-violet-700 outline-none resize-none
            rounded w-full p-4 h-36 text-sm text-grey-300'placeholder='Message*'></textarea>
            <div className='flex gap-x-2'>
              ...
              hover:border-red-700 hover:text-black-500 rounded p-4 w-full text-sm transition'>Call</button>
            </div>
          </form>
        </div>
      </div>
